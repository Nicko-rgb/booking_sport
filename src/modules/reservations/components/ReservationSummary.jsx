...
const ReservationSummary = ({ open, onClose, onConfirm, onBackToListTime, onContinueToPayment }) => {
    ...
    const manejarContinuarAPago = () => {
        ...
        console.log('Continuando al pago:', reservationData);

        // Llamar al callback para mostrar métodos de pago
        onContinueToPayment(reservationData);
    };
